...
\begin{itemize}
  \item 利用SofaArk框架，开发了数据治理的检查器开放平台；利用反射机制实现插件注册和引用；使用Quartz任务调度框架，实现心跳的failover机制来保证中台的高可用。
  \item 开发了一系列检查器和治理项，如暴力扫描、CU消耗检测等保障数据质量；开发了数据治理中心的如健康分趋势、数据治理项、数据检查项、白名单机制等一系列数据治理API。
\end{itemize}
\end{onehalfspacing}
