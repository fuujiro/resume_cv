...
\datedsubsection{\textbf{\includegraphics[scale=0.5]{img/alibabacloud.pdf} 阿里云 - 计算平台DataWorks ~/~ 后端研发实习生}}{2021.4 -- 至今为止}
\vspace{-0.5ex}
...
\datedsubsection{\textbf{\includegraphics[scale=0.5]{img/tencentqq.pdf} 腾讯游戏 - 光子工作室群 ~/~ 后台开发实习生}}{2020.12 -- 2021.4}
\vspace{-0.5ex}
%\role{\LaTeX, Python}{个人项目}
\begin{onehalfspacing}
%优雅的 \LaTeX\ 简历模板, https://github.com/billryan/resume
